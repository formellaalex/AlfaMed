...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'alfamed7_cms', 'user' => 'alfamed7_graz', 'password' => 'swietojanska86', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/CMSBundle/Resources/config/doctrine') => 'CMSBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'CMSBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('CMSBundle' => 'CMSBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_98d81fbf41b085b187e910eaa8fa92c16811239a968822562878d216a1c6af68');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CMSBundle/Resources/views'), 'CMS');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('12323fsdcsqedsa232');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5c71a891dfaa20.03615907')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'CMSBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CMSBundle'),
                    'namespace' => 'CMSBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'database_port' => 3306,
            'database_name' => 'alfamed7_cms',
            'database_user' => 'alfamed7_graz',
            'database_password' => 'swietojanska86',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '12323fsdcsqedsa232',
            'locale' => 'en',
            ...
            'kernel.secret' => '12323fsdcsqedsa232',
